          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-lg px-3 py-2 pr-10 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 autofill:bg-white autofill:text-gray-900"
              />
              <button
                type="button"
